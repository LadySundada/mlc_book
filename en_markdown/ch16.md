...
学习者能够从动作和环境变化的练习经历中获得的一个重要的益处是，提高了在未来测试中执行该技能的能力。这意味着学习者不仅提高了执行所练技能本身的能力，而且还能在可能<u>表征测试情景</u>的新环境下执行技能，例如在竞赛项目中。从学习迁移的角度来看，我们感兴趣的是练习到测试的迁移，而在练习中引入动作和环境的变化可以看作是为增强从练习环境到测试环境的正迁移而采取的一种手段。
